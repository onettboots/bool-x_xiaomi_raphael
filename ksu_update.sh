...
git subtree pull --prefix=drivers/kernelsu https://github.com/sidex15/KernelSU-Next next-susfs --squash -m "drivers: kernelsu: update"

# Lets tricky calculating for the reall version here
rm -rf ksu
git clone https://github.com/sidex15/KernelSU-Next -b next-susfs ksu
cd ksu
KSU_VERSION=10200
