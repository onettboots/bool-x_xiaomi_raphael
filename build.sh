...
OCDS=$(grep -qP "timing@1\s*{" arch/arm64/boot/dts/qcom/xiaomi/overlay/common/display/dsi-panel-ss-fhd-ea8076-cmd.dtsi && echo "OCD" || echo "No-OCD")
...
function build_ocd() {
      		...
      		git restore arch/arm64/boot/dts/qcom/xiaomi/overlay/common/display/dsi-panel-ss-fhd-ea8076-cmd.dtsi
      		git restore arch/arm64/boot/dts/qcom/xiaomi/overlay/common/display/dsi-panel-ss-fhd-ea8076-global-cmd.dtsi
}
...
\
         timing@4 {\
            ...
            qcom,display-topology = <1 0 1>;\
            qcom,default-topology-index = <0>;\
' arch/arm64/boot/dts/qcom/xiaomi/overlay/common/display/dsi-panel-ss-fhd-ea8076-cmd.dtsi
...
\
         timing@4 {\
            ...
            qcom,display-topology = <1 0 1>;\
            qcom,default-topology-index = <0>;\
' arch/arm64/boot/dts/qcom/xiaomi/overlay/common/display/dsi-panel-ss-fhd-ea8076-global-cmd.dtsi
}
